Release Notes for SATNET 0.93
==================================
[SATNET][], historical release notes refreshed May 2026

These notes accompany the release in April 2016 of version 0.93 of the [SATNET]
...
This release of SATNET has been tested on a variety of Android devices, and is
...
Previous releases of SATNET were known to work on the following devices with
minor problems:
 ...
 * If a user starts a SATNET hotspot on the "Connect" screen, then the
   ...
   with "ap.satnet.app".  When the SATNET hotspot is turned off, SATNET
...
Earlier development of SATNET has been funded by the [New America
...
SATNET MAY TRANSMIT SOME DATA IN THE CLEAR.
...
-----
**Copyright 2016 original upstream authors; SATNET documentation refresh 2026.**  
