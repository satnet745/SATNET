...
off normal Wi-Fi network access** while SATNET is running, and services
...
On the SATNET "Connect" screen, connecting to any network marked "HotSpot"
...
On the SATNET "Connect" screen, connecting to any network marked "Mesh"
...
SATNET, **this will cut off normal Wi-Fi network access** while SATNET
is running, and services like Google Updates, E-mail, social media and
...
Development of the upstream mesh project was funded by the [New America Foundation's][NAF]
